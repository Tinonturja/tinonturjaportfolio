      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Bridging industrial processes and data-driven insights
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {experience.map((exp, index) => (
              <div
                key={exp.role}
                className="relative pl-8 before:absolute before:left-0 before:top-2 before:w-3 before:h-3 before:bg-primary before:rounded-full before:shadow-[0_0_10px_hsl(48_100%_50%/0.5)] after:absolute after:left-[5px] after:top-6 after:w-0.5 after:h-[calc(100%-1rem)] after:bg-border last:after:hidden animate-fade-up"
